...
export type PlaylistsQueryQuery = { __typename?: 'Query' } & {
 ...
 * });
 */
export function usePlaylistsQueryQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    PlaylistsQueryQuery,
    PlaylistsQueryQueryVariables
  >,
) {
  return ApolloReactHooks.useQuery<
    PlaylistsQueryQuery,
    PlaylistsQueryQueryVariables
  >(PlaylistsQueryDocument, baseOptions);
}
export function usePlaylistsQueryLazyQuery(
...
export type PlaylistsQueryQueryHookResult = ReturnType<
  typeof usePlaylistsQueryQuery
>;
export type PlaylistsQueryLazyQueryHookResult = ReturnType<
  typeof usePlaylistsQueryLazyQuery
>;
export type PlaylistsQueryQueryResult = ApolloReactCommon.QueryResult<
  PlaylistsQueryQuery,
  PlaylistsQueryQueryVariables
>;
